...
echo ""
echo "Next: ./02_login.sh"
echo ""
echo "Tip: Override defaults with env vars:"
echo "  ROLE=customer EMAIL=fan@example.com ./01_register_user.sh"
echo "  Valid roles: organizer, customer"
